Visualisation Engine Readme

Overview: some addons and modifications to Kelvin's original google maps display

1. Added javascript to read and display data from weatherhistory xml.
2. Added play button, progress slider, speed control
